...
const Feet = () => {   
   ...
   const handleResult = (e) => {
     e.preventDefault();
     const cal = Math.round(height * width * quantity * rate);
    ...
    return ( 
      <div className="cal">
            <form onSubmit={handleResult}>
              <h5>Feet <button className="btn-switch"><Link to ="/">switch</Link></button></h5>
            <p>Height</p>
            <input type="number" value={height} onChange={(e) => setHeigth(e.target.value)} required/>
            <p>Width</p>
